...
#if (IS_ESP == 1)
#define READ_CODE_OPT READ_CODE
#define WRITE_CODE_OPT WRITE_CODE
#else
#if (COH_MODE == SPX_OWNER_PREDICTION)
#define READ_CODE_OPT 0x4002B30B
#define WRITE_CODE_OPT 0x2262B82B
#elif (COH_MODE == SPX_WRITE_THROUGH_FWD)
#define READ_CODE_OPT 0x4002B30B
#define WRITE_CODE_OPT 0x2062B02B
#elif (COH_MODE == SPX_BASELINE_REQV)
#define READ_CODE_OPT 0x2002B30B
#define WRITE_CODE_OPT 0x0062B02B
#else
#define READ_CODE_OPT READ_CODE
#define WRITE_CODE_OPT WRITE_CODE
#endif
